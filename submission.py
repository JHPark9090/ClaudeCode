    ...
    def __init__(self, challenge):
        ...
        if challenge==1:
            self.real_model = QuixerTimeSeriesPennyLane(
                sim14_circuit_config=['RY', 'CRX', 'RX', 'CRY_counter'],
...
class Submission:
    ...
    def get_model_challenge_1(self):
        ...
        model_path = Path(__file__).parent / "weights_challenge_1_TB.pt"
    ...
    def get_model_challenge_2(self):
        ...
        model_path = Path(__file__).parent / "weights_challenge_2_TB.pt"
        if model_path.exists():
